...
#                         conn.request("GET",
#                                      "https://2factor.in/API/R1/?module=SMS_OTP&apikey=307d8dcd-da69-11ec-9c12-0200cd936042&to=" + phone + "&otpvalue=" + str(
#                                          key))
...
#                 conn.request("GET",
#                              "https://2factor.in/API/V1/307d8dcd-da69-11ec-9c12-0200cd936042/SMS/VERIFY/" + otp_session_id + "/" + otp_sent)
#                 res = conn.getresponse()
#                 data = res.read()
#                 print(data.decode("utf-8"))
#                 data = data.decode("utf-8")
